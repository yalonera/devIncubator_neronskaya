...
<center>
    ...
    <form action="">
        ...
        <p><input type="text" name="richest user " value="<%resultSet.getString("richest user");%>" size="100">
            <input type="button" name=".get">
        </p>
<%
    }
...
%>
        ...
        <p><input type="text" name="account sum " value="<%resultSet1.getString("account sum"); %>" size="100">
